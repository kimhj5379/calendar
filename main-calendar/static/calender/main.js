...
var FullCalendar = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    const texts = [
        ...
        '행복은 습관이다,그것은 너의 몸에 배어야 한다 -다라이 라마',
        '행복은 당신이 생각하는 것보다 더 가까이에 있다 -마르쿠스 아우렐리우스',
      ...
      function changeText() {
        ...
        const oldText = container.querySelector('.text-slide');
      
        if (oldText) {
          oldText.style.animation = 'slide-out 0.6s ease forwards';
          ...
          setTimeout(() => {
            ...
            newText.className = 'text-slide';
            newText.textContent = texts[current];
            newText.style.animation = 'slide-in 0.6s ease forwards';
            ...
            return (createElement(DayCellRoot, { date: date, dateProfile: dateProfile, todayRange: props.todayRange, showDayNumber: props.showDayNumber, extraHookProps: props.extraHookProps, elRef: this.handleRootEl }, function (dayElRef, dayClassNames, rootDataAttrs, isDisabled) { return (createElement("td", __assign({ ref: dayElRef, className: ['fc-daygrid-day'].concat(dayClassNames, props.extraClassNames || []).join(' ') }, rootDataAttrs, props.extraDataAttrs),
                createElement("div", { className: "fc-daygrid-day-frame fc-scrollgrid-sync-inner", ref: props.innerElRef /* different from hook system! RENAME */ },
                    ...
                    createElement("div", { className: "fc-daygrid-day-events", ref: props.fgContentElRef },
                        props.fgContent,
                        createElement("div", { className: "fc-daygrid-day-bottom", style: { marginTop: "-5px" } },
